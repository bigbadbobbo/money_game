...
//buttons[1].addEventListener("click", buttonListener)
//buttons[2].addEventListener("click", buttonListener)
//buttons[3].addEventListener("click", buttonListener)
//buttons[4].addEventListener("click", buttonListener)
